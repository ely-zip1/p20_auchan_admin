...
(1, 3, '2022-07-13 00:06:00', '2022-07-13 00:39:29', '90', 1, 1, 0, 0),
(2, 5, '2022-07-13 02:50:59', '2022-07-13 02:52:20', '90000', 12, 7, 0, 0),
(3, 3, '2022-09-22 03:18:51', NULL, '1000', 1, 2, 1, 0),
(4, 3, '2022-09-22 03:22:48', NULL, '1000', 3, 2, 1, 0);
...
(1, 'Bitcoin', '39aaue3etAGyJiWH3AZzH7ALiAfbr5PZa9', '', ''),
(3, 'Ethereum', '0x9a40a609c3b0b2075aa8a05318c5499b23f80dfd', '', ''),
(11, 'Account Balance', '', '', ''),
(12, 'XRP', 'rnqZnvzoJjdg7n1P9pmumJ7FQ5wxNH3gYC\r\n', '47762767', ''),
(13, 'Tron', 'TQW1AtthBWGoV2xvusWmCQstZ7WWu8N5Fp', '', ''),
(14, 'Litecoin', 'ME4m4vWoenVwxXThxa7udB73Z9SU6HMmP5', '', ''),
(16, 'Doge Coin', '', '', ''),
(17, 'Activation Fund', '', '', '');
...
--
-- Dumping data for table `td_fund_bonus`
--

INSERT INTO `td_fund_bonus` (`id`, `member_id`, `referral_bonus_id`, `amount`) VALUES
(1, 3, 1, 6750);
...
CREATE TABLE `td_fund_transfer` (
  ...
  `amount` decimal(10,2) NOT NULL,
  `date` datetime NOT NULL DEFAULT current_timestamp(),
  `source_of_fund` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
...
--
-- Dumping data for table `td_lifestyle_bonus`
--

INSERT INTO `td_lifestyle_bonus` (`id`, `member_id`, `referral_bonus_id`, `amount`) VALUES
(1, 3, 1, 135);
...
(3, 'uno uno uno', 'uno', 'ez@gmail.com', '2022-07-12 22:09:48', '$2y$11$uVizruKc3R9VhMOLJDQMqehvxCfkNTejcA9fP/CdxEeLeml/hSj1K', 2, '', '', 1, 'INTSEAINC', 'root', '86214', '2022-07-12 22:09:48'),
(4, 'isi admin', 'isiadmin', 'seawaysinternationaladmin@gmail.com', '2022-07-12 23:36:11', '$2y$11$hH3592RCcN.qwFMyN6.NU.z3PWOC8is4xG/Q0lDx37U9vRkCEmoCG', 1, '', '', 1, 'INTSEAINC', 'root', '', '2022-07-12 23:36:11'),
(5, 'dos d dos', 'dos', 'seawaysinternational730@gmail.com', '2022-07-13 02:45:58', '$2y$11$lVwmmj3L7rnIksDPmKnnOuQTPlohvlvOxq8ZPZNctjZetKt3BOuw.', 2, '', '', 1, 'INTSEAINC', 'uno', '71954', '2022-07-12 18:45:58'),
(6, 'tres', 'tres', 'lk@g.c', '2022-07-13 23:08:40', '$2y$11$4NFuvGJwZWimFghDbISvWerpvL3lWACedXsz1ESFncat4jAwp.ULG', 2, '', '', 1, 'INTSEAINC', 'uno', '', '2022-07-13 23:08:40'),
(7, 'four', 'four', 'eee@g.c', '2022-07-13 23:09:43', '$2y$11$QA2YRaH5rUM/Zi4wxG5ZueqwVIa6oTltdHyD9036a/.yO1p4bXJuu', 2, '', '', 1, 'INTSEAINC', 'tres', '', '2022-07-13 23:09:43');
...
(1, 'AVIA PREMIER', 1.6, 90, 899.99, 200, NULL),
(2, 'AVIA PRIVILEGE', 1.8, 900, 8999.99, 180, NULL),
(5, 'AVIA ENTERPRISE', 2, 9000, 89999, 160, NULL),
(7, 'SUEZMAX PLAN', 2.2, 90000, 10000000000, 140, NULL);
...
--
-- Dumping data for table `td_withdrawals`
--

INSERT INTO `td_withdrawals` (`id`, `is_from_bonus`, `member_id`, `date`, `date_approved`, `amount`, `payment_method`, `is_pending`) VALUES
(1, 0, 3, '2022-09-22 10:26:33', '0000-00-00 00:00:00', '300', 'Ethereum', 1);
