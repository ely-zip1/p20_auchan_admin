                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="login-brand">
                                <a href="<?= base_url(); ?>">
                                    <img src="<?= base_url(); ?>assets/img/Spar_logo.svg" alt="SPAR logo" width="250px">
                                </a>
                                <br>
                                <br>
                                <span class="brand-group">SIGN UP</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body login_card_body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="reg-username logreg_input" type="text"
                                value="<?= set_value('username', '', true) ?>" class="form-control login_input <?php if (strlen(form_error('username')) > 0) {
                                            echo "is-invalid";} ?>" name="username" autofocus required />
                            <div class="invalid-feedback">
                                <?php echo form_error('username'); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="fullname" class="log_reg_label">Full Name:
                                <!-- <small class="text-muted">(Given
                                    name,
                                    Middle initial, Family name)</small> -->
                            </label>
                            <input id="fullname logreg_input" type="text" value="<?= set_value('fullname', '', true) ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select id="reg_country" name="reg_country" placeholder="Select recipient's country" class="form-control form-control-sm <?php if (strlen(form_error('reg_country')) > 0) {
                                            echo "is-invalid";} ?>"
                                value="<?= set_value('reg_country', '', true) ?>" />
                            <option value=""></option>
                            ...
                            <div class="invalid-feedback">
                                <?php echo form_error('reg_country'); ?>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="referral" class="log_reg_label">Affiliate code:
                            </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-lg btn-block spar-red-btn">Create
                                    Account</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <span class="login-link">
                                    Have an account?
                                    <a class="sign_up" href="<?= base_url('login'); ?>">Login</a>
                                </span>
                            </div>
                        </div>
