...
<!-- Modal -->
<div class="modal fade" id="sendPackageModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<body class="body-custom-admin" onload="set_interval()" onmousemove="reset_interval()" onclick="reset_interval()"
  ...
  $this->load->view('admin/templates/layout');
