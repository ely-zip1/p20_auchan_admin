...
class Spar_fund_admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($member_list as $member) {
            ...
            // print_r($member);
            $total_spar_fund = $this->Spar_fund_model->get_member_balance($member->id);

            $temp = array();
            $temp['id'] = $member->id;
            $temp['full_name'] = $member->full_name;
            $temp['email'] = $member->email_address;
            $temp['total_fund'] = $total_spar_fund;
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('admin/pages/spar_fund', $data);
            ...
            $this->Spar_fund_model->add($new);

            redirect('spar_fund_admin');
            // $this->load->view('admin/templates/header', $data);
